...
def from_kg():
    ...
    # Empty the Text boxes if the had text from the previous use and fill them again
...
e1.grid(row=0, column=0) # The label is placed in position 0, 0
...
# The from_kg() function is called when the button is pressed
